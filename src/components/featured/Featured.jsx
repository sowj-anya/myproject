    ...
    <div className='featured'>
       ...
       <div className="featuredItem">
            ...
            <div className="featuredTitles">
                {/* <h1>Dublin</h1> */}
                {/* <Button style={{color:'white'}}><h1>Dublin</h1></Button> */}
                <Button style={{color:'white'}} onClick={()=>navigate('/dublin')}><h1>Dublin</h1></Button>
        ...
        <div className="featuredItem">
            ...
            <div className="featuredTitles">
                {/* <h1>Austin</h1> */}
                {/* <Button style={{color:'white'}}><h1>Austin</h1></Button> */}
                <Button style={{color:'white'}} onClick={()=>navigate('/austin')}><h1>Austin</h1></Button>
        ...
        <div className="featuredItem">
            ...
            <div className="featuredTitles">
                {/* <h1>Reno</h1> */}
                {/* <Button style={{color:'white'}}><h1>Reno</h1></Button> */}
                <Button style={{color:'white'}} onClick={()=>navigate('/reno')}><h1>Reno</h1></Button>
